...
/*==================================================================
    [ Show modal22 ]*/
    $('.js-show-modal22').on('click',function(e){
        e.preventDefault();
        $('.js-modal22').addClass('show-modal1');
    });

    $('.js-hide-modal22').on('click',function(){
        $('.js-modal22').removeClass('show-modal1');
    });
    /*==================================================================
    [ Show modal23 ]*/
    $('.js-show-modal23').on('click',function(e){
        e.preventDefault();
        $('.js-modal23').addClass('show-modal1');
    });

    $('.js-hide-modal23').on('click',function(){
        $('.js-modal23').removeClass('show-modal1');
    });
     /*==================================================================
    [ Show modal24 ]*/
    $('.js-show-modal24').on('click',function(e){
        e.preventDefault();
        $('.js-modal24').addClass('show-modal1');
    });

    $('.js-hide-modal24').on('click',function(){
        $('.js-modal24').removeClass('show-modal1');
    });
})(jQuery);